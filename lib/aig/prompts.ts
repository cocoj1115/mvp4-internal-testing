...
export function buildItemPrompt(
  ...
  const system = [
    ...
    "       • Keep all elements within x∈[10,530] y∈[10,310]. Never place anything outside this.",
    ...
    "         break it into two <tspan> lines (dy='1.2em' for the second).",
    ...
    "     visual detail beyond simple shapes → provide illustration_prompt.",
