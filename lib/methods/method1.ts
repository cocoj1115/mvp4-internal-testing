...
export async function gradeWithMethod1(
  ...
  const scoringSystemPrompt = [
    ...
    "- For score=1: write exactly ONE confirmatory sentence ending with '.' or '!'.",
    ...
    "ABSOLUTE CONSTRAINTS:",
    "- score=1: exactly ONE sentence ending with '!' or '.'. No second sentence, no question, no extra teaching.",
